...
export function MediaEditDialog({ media, open, onOpenChange, onSave, onDelete, onSuccess }: MediaEditDialogProps) {
  ...
  try {
    ...
    // Then trigger the parsing and analysis
