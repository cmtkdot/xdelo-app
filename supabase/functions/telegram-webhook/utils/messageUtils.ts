 ...
 * }
 */ export function extractMediaContent(message) {
  if (!message) return undefined;
 ...
 *   correlationId
 * );
 */ export async function processCaptionWithRetry(captionText, correlationId) {
 ...
 *   newMediaContent
 * );
 */ export function hasMediaContentChanged(oldMedia, newMedia) {
