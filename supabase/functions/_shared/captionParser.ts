...
/**
 * Shared caption parser that uses simple pattern matching to extract information
 * from message captions. This is used across edge functions and database triggers
...
export function xdelo_parseCaption(
  ...
  // If no caption, return minimal structure
  if (!caption) {
    return {
      parsing_metadata: {
