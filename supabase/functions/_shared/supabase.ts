  ...
  return createClient(supabaseUrl, supabaseKey, {
    ...
    global: {
      ...
      headers: {
        ...
        'x-statement-timeout': `${timeoutSeconds * 1000}`, // Add timeout header
      },
    },
...
// TODO: Implement retry logic within executeQuery if needed
...
/**
 * Type-safe wrapper for common database operations (Retry logic can be added here)
 */
