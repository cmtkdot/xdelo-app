-- Migration to update the caption processing workflow
-- Changes:
-- 1. Messages with empty captions remain in 'processing' state instead of being marked 'completed'
-- 2. Simplified state transitions
-- 3. Direct caption parsing and media group sync
