-- Migration to fix chat_type validation in upsert_media_message function
-- This ensures that any chat type from Telegram is properly mapped to one of the valid telegram_chat_type enum values
